...
def add_muscles(
    ...
    for mtu in muscles:
        ...
        heights = np.linspace(start=-0.5, stop=muscle_length, num=1000, dtype=float)
    ...
    print("num muscles", len(model.actuator.general))
    everything_ok = False
    while not everything_ok:
        try:
            ...
            print(muscle_index)
            print(model.actuator.general[muscle_index].name)
