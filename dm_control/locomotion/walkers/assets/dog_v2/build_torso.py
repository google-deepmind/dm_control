...
def create_torso(model, bones, bone_position,
                 lumbar_dofs_per_vertebra, side_sign, parent):
  """Add torso in the dog model.
      ...
      Args:
        ...
        lumbar_dofs_per_vertebra: a number that the determines how many
        dofs are going to be used between each pair of lumbar vetebrae.
