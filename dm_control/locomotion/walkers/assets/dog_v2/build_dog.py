...
flags.DEFINE_boolean("use_muscles", False, "Whether to use muscles or torque actuators")
flags.DEFINE_boolean(
...
def exclude_contacts(model):
    ...
    model.contact.add("exclude", name="C_4:scapula_R", body1="C_4", body2="scapula_R")
    model.contact.add("exclude", name="C_4:scapula_L", body1="C_4", body2="scapula_L")
    model.contact.add(
...
def main(argv):
    ...
    if not use_muscles:
        ...
        name = "dog_muscles_{}_{}.xml".format(muscle_strength_scale, muscle_dynamics)
