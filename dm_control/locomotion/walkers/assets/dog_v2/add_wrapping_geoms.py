...
def add_wrapping_geoms(model):
    ...
    for i in range(1, 8, 1):
        ...
        body.add("geom", name=f"L_{i}_wrapping", size=[0.009, 0.04], dclass="wrapping")
        body.add(
            "site",
    ...
    foot_L.add("geom", name="ankle_L_wrapping", dclass="wrapping", size=[0.02, 0.05])
    foot_L.add(
        "site",
    ...
    foot_R.add("geom", name="ankle_R_wrapping", dclass="wrapping", size=[0.02, 0.05])
    foot_R.add(
        "site",
