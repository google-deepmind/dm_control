...
class Rope(base.Task):
    ...
    def initialize_episode(self, physics):
        ...
        if self._multi_task:
            self._current_task = np.random.cohice([0, 45, 90, 135])
        else:
    ...
    def get_reward(self, physics):
        true_geoms = np.load(f'/home/wilson/dm_control/dm_control/suite/rope_geoms/rope_{self._current_task}.npy')
